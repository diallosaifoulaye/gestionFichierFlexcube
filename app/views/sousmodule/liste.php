        ...
        <div class="container-fluid">
            ...
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title"><?php echo $this->lang['sousModule']; ?></h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">

                    <ol class="breadcrumb">
                        <li><a href="<?= WEBROOT.'administration/index'; ?>">  <?php echo $this->lang['administration']; ?></a></li>
                        <li class="active"><?php echo $this->lang['sousModule']; ?></li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    ...
                                    <button type="button" class="open-modal btn btn-success"
                                        ...
                                        <i class="fa fa-plus"></i> <?php echo $this->lang['btnAjouterSousModule']; ?>
                                    </button>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-bordered table-hover table-responsive processing"
                                       data-url="<?= WEBROOT; ?>sousModule/listeProcessing">
                                    <thead>
                                    <tr>
                                        <th><?php echo $this->lang['labModule']; ?></th>
                                        <th><?php echo $this->lang['labSousModule']; ?></th>
