                        ...
                        <div class="col-lg-12">
                            <h3 class="panel-title pull-right">
                                <button type="button" class="open-modal btn btn-success"
                                        data-modal-controller="administration/newParametrage"
                                        data-modal-view="admin/create">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?= WEBROOT; ?>administration/listeProcessing">
                                <thead>
                                <tr>
                                    <th><?php echo $this->lang['agence_libelle']; ?></th>
