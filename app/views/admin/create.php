<?php //var_dump($parametrage);exit;?>
<form id="validation" class="form-inline form-validator" data-type="update" role="form" action="<?= WEBROOT ?>administration/<?= ((isset($parametrage->rowid)) ? "edit" : "create") ?>" method="post">
                ...
                <div class="col-sm-6">
                    <div class="form-group" style="width: 100%;padding: 10px;">
                        ...
                        <input type="text" id="libelle" name="libelle" class="form-control" placeholder="<?php echo $this->lang['agence_libelle']; ?>"
                               value="<?= $parametrage->libelle; ?>" style="width: 100%" required>
