    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title"><?php echo $this->lang['region_list']; ?></h4></div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang['region_list']; ?></li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
...
<!--                                        data-modal-controller="administration/regionModal"-->
<!--                                        data-modal-view="admin/regionModal">-->
<!--                                    <i class="fa fa-plus"></i> --><?php //echo $this->lang['btnAjouterRegion']; ?>
<!--                                </button>-->
                            </h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <table class="table table-bordered table-hover table-responsive processing"
                                   data-url="<?php echo WEBROOT; ?>administration/regionProcessing">
                                <thead>
                                <tr>
                                    <th><?php echo $this->lang['labelregion']; ?></th>
