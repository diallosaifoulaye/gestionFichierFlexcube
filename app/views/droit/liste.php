                            ...
                            <div class="col-lg-12">
                                <h3 class="panel-title pull-right">
                                    ...
                                    <button type="button" class="open-modal btn btn-success"
                                            data-modal-controller="droit/droitModal"
                                            data-modal-view="droit/droitModal">
                                        <i class="fa fa-plus"></i> <?php echo $this->lang['btnAjouterDroit']; ?>
                                    </button>
                                </h3>
                            </div>
                        </div>
